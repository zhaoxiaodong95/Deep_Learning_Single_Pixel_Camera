...
class ConvLSTM(nn.Module):
    def __init__(self, input_channels, hidden_channels, kernel_size, frame_size, n_filters, hidden_size, device, step=1): #, effective_step=[1]
        ...
        self.cnn_before_lstm.add_module('conv0', nn.Conv2d(666, 256, 3, 1, 1))
        self.cnn_before_lstm.add_module('batchnorm0', nn.BatchNorm2d(256))
        self.cnn_before_lstm.add_module('relu0', nn.ReLU())
        self.cnn_before_lstm.add_module('conv1', nn.Conv2d(256, 256, 3, 1, 1))
        self.cnn_before_lstm.add_module('batchnorm1', nn.BatchNorm2d(256))

        self.cnn_after_lstm = nn.Sequential()
        self.cnn_after_lstm.add_module('conv2', nn.Conv2d(64, 256, 3, 1, 1))
        self.cnn_after_lstm.add_module('batchnorm2', nn.BatchNorm2d(256))
        self.cnn_after_lstm.add_module('relu2', nn.ReLU())
        self.cnn_after_lstm.add_module('conv3', nn.Conv2d(256, 1, 3, 1, 1))
    ...
    def forward(self, image, phi_0):
        ...
        for step in range(self.step):
            ...
            phi_t = phi_0 + 0.05 * self.cnn_meas(x_output)
